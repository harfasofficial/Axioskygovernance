...
Note: a few specialized services (audit chain writes and escalation workflow
writes) still open direct sessions for transactional or background-task reasons.
"""
